...
class _$NewsTearOff {
  ...
  _News call(int id, String url, String title, String description) {
    return _News(
      id,
      url,
      title,
...
abstract class $NewsCopyWith<$Res> {
  ...
  $Res call({int id, String url, String title, String description});
}
...
class _$_News implements _News {
  _$_News(this.id, this.url, this.title, this.description);
  ...
  @override
  String toString() {
    return 'News(id: $id, url: $url, title: $title, description: $description)';
  }
...
abstract class _News implements News {
  factory _News(int id, String url, String title, String description) = _$_News;
